                    ...
                    <div id="content-main" class="standard-box-alt">
                        <div class="content-assessment standard-padding">
                            ...
                            <div class="assessment-header">
                                <h2 class="heading heading--bold heading--inline">COMPLETE THE ASSESSMENT</h2>
                                <p class="assessment-status--text assessment-status--right"><i class="icon-empty-box"></i>(Incomplete)</p>
                                <div class="assessment-body">
                                    <a class="assessment-status--text assessment-status--link assessment-status--right" href="/RiskProfile/Assessment/73065215-ae0c-42d4-aae8-882eb4c42b01">
